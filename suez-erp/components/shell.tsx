...
/** `caps` narrows a single item to people who hold one of those capabilities. */
  ...
  const nav = (
    <nav className="flex-1 space-y-5 overflow-y-auto px-3 py-4">
      {groups
        ...
        // Hiding an item the server would bounce them from anyway. The sidebar
        // used to offer staff Invoices and Budgets and then redirect them home
        // with no explanation.
