 ...
 * Who can do what.
 *
 * ponytail: this screen did not exist. Authority was six role names hardcoded
 * across about a hundred checks, so adding a role meant a code change and a
 * deploy, and nobody could answer "what exactly can Finance do?" without
 * reading the source. Roles are data now; the capability list they draw from is
    ...
    <>
                ...
                <div>
                  ...
                  {r.capabilities.length === 0 ? (
                    <p className="text-sm font-medium text-ink-soft">
                      Everyday access only — their own leave, timesheets, expenses and requests.
                    </p>
                  ) : (
      ...
      <Card className="mt-5">
        <p className="text-xs font-medium text-ink-soft">
          ...
          code checks. Two rules hold whatever a role says: nobody approves their own expense, leave, timesheet or
          requisition, and a line manager can always decide their own reports.
        </p>
      </Card>
    </>
  );
