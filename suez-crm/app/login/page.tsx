        ...
        <div className="relative">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-semibold tracking-wide text-brand-300">Customer relationship management</p>
            </div>
          </div>
        </div>

        <div className="relative max-w-md">
          <h1 className="text-[2.75rem] leading-[1.1] font-bold tracking-[-0.03em]">Turn relationships into revenue.</h1>
          <p className="mt-5 text-[15px] leading-relaxed text-white/70">
            Manage prospects, customers, opportunities and support activity in a focused sales workspace.
          </p>
          <ul className="mt-8 space-y-3 text-sm font-semibold">
            {[
              "Lead scoring and conversion",
              "Companies, contacts and activity history",
              "Opportunity pipeline and sales quotes",
              "Campaigns, segments and support tickets",
            ].map((t) => (
